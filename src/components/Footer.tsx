          ...
          <div className="col-span-12 md:col-span-4">
            <div>
              ...
              <p className="text-background/70 leading-relaxed mb-6">
                Automated background KYC for high-volume hiring and verifying renter identities in seconds to secure your assets.              </p>
              {/* Social Media Icons */}
        ...
        <div className="border-t border-background/20 pt-8 mt-16">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-background/70 mb-4 md:mb-0">
              © 2025 VerifyStack. All rights reserved.
            </div>
